...
void evaluation_insertion_set(set<long long> &set, double &time, int count, long long key, double** Set, int tElem[], int i){
...
void evaluation_searching_set(set<long long> &set, long long element, double Set[], int i){
...
int main(int argc, char* argv[]){
    ...
    freopen("../results/mainSET.txt","w",stdout); 
    ...
    cout << "\n";
    cout << "SIZE OF SET WITH USER_ID " << (sizeof(SET_ID) + sizeof(long long) * SET_ID.size())*pow(10,-3) << "[KB]" << endl;
    cout << "SIZE OF SET WITH USER_NAME " << (sizeof(SET_NAME) + sizeof(long long) * SET_NAME.size())*pow(10,-3) << "[KB]" << endl;
    cout << "\n";
